...
Dual-licensed under [MIT](https://github.com/gozelle/jsonrpc/blob/master/LICENSE-MIT) + [Apache 2.0](https://github.com/gozelle/jsonrpc/blob/master/LICENSE-APACHE)
