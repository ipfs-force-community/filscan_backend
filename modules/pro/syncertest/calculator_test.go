...
import (
	...
	"gitlab.forceup.in/fil-data-factory/filscan-backend/modules/pro/syncer"
...
func TestProCalculator(t *testing.T) {
	...
	initEpoch := chain.MustBuildEpochByTime("2023-09-08 01:00:00").Int64()
	spew.Json(initEpoch)
