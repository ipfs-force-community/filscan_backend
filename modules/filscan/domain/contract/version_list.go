...
type SolidityVersions []string

func (s SolidityVersions) GetVersionList() SolidityVersions {
	// 也可通过解析https://binaries.soliditylang.org/wasm/list.json来获取最新的所有版本，但版本更新周期较长，定期手动更新对性能更好
	return []string{
...
func (l Licenses) GetLicenseList() Licenses {
	return []string{
		"No License (None)",
